...
public class EinUndAusgabe {
	 ...
	 * Tastatur eingegeben wird. Die Eingabe endet mit der Return-Taste und darf
	...
	/**
	 * Methode zum Lesen einer ganzen Zahl von der Konsole, die &uuml;ber die
	 * Tastatur eingegeben wird. Die Eingabe endet mit der Return-Taste. Sollte
	 * es sich bei der Eingabe um keinen g&uuml;ltigen Wert handeln, wird -1
	 * zur&uuml;ckgegeben.
	 * 
	...
	/**
	 * Methode zum Lesen einer Float-Zahl von der Konsole, die &uuml;ber die
	 * Tastatur eingegeben wird. Die Eingabe endet mit der Return-Taste. Sollte
	 * es sich bei der Eingabe um keinen g&uuml;ltigen Wert handeln, wird -1
	 * zur&uuml;ckgegeben.
	 * 
	...
	/**
	 * Methode zum Lesen einer Double-Zahl von der Konsole, die &uuml;ber die
	 * Tastatur eingegeben wird. Die Eingabe endet mit der Return-Taste. Sollte
	 * es sich bei der Eingabe um keinen g&uuml;ltigen Wert handeln, wird -1
	 * zur&uuml;ckgegeben.
	 * 
	...
	/**
	 * Methode zum Lesen eines Wahrheitswertes von der Konsole, der &uuml;ber
	 * die Tastatur eingegeben wird. Die Eingabe endet mit der Return-Taste.
	 * Sollte es sich bei der Eingabe nicht um "true" handeln, wird false
	 * zur&uuml;ckgegeben.
	 * 
	 ...
	 * 
	 * @param text
	 *            auszugebender Text, der Spezialzeichen wie %d als Platzhalter
	 *            f&uuml;r auszugebene Variablen enthalten kann
	 * @param objekte
	 *            Objekte, die an Stelle der Platzhalter im Text ausgegeben
	 *            werden sollen
	 */
	public void formatiertAusgeben(String text, Object... objekte) {
		System.out.printf(text, objekte);
	}

	/**
	 * Methode zur Erzeugung einer ganzahligen Zufallszahl zwischen
	 * (einschlie&szlig;lich) den &uuml;bergebenen Grenzen. Es wird erwartet und
	 * nicht gepr&uuml;ft, dass der Endwert nicht kleiner als der Startwert ist.
	 * 
	 * @param start
	 *            minimal m&ouml;glicher Zufallswert
	 * @param ende
	 *            maximal m&ouml;glicher Zufallswert
	 * @return zuf&auml;lliger Wert zwischen start und ende (auch diese beiden
	 *         Werte sind m&ouml;glich
	 */
	public int zufall(int start, int ende) {
		return start + (int) (Math.random() * (ende - start + 1));
	}
}
